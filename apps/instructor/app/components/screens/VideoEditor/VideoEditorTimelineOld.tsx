...
const OrignalTimeline = () => {
  ...
  const handleZoomOut = () => {
    setZoomLevel((prev) => Math.min(prev + 0.1, maxZoomLevel));
  };

  const handleZoomIn = () => {
    setZoomLevel((prev) => Math.max(prev - 0.1, minZoomLevel));
  };
  ...
  //   setPlayheadPosition(newPlayheadPosition);
  //   console.log("Playhead position set to:", newPlayheadPosition);
  //   setCurrentTimeSec(currentTimeSec + newPlayheadPosition)
  // };
  ...
  //   // Use absolute playheadPosition without adding scroll
  //   for (let i = 0; i < timelineItems.length; i++) {
  //     const currentDivWidth = getWidthByDuration(timelineItems[i].duration);
  //     if (
  //       playheadPosition >= accumulatedWidth &&
  //       playheadPosition < accumulatedWidth + currentDivWidth
  //     ) {
  //       const clickPosition = playheadPosition - accumulatedWidth;
  ...
  return (
    <div ref={parentRef} className="bg-red-500">
      <div className="flex items-center justify-between relative  mb-2">
        <div className="flex items-center gap-1 border-[#E9E9EA] border rounded-[5px] px-[6px] py-1 cursor-pointer"></div>
        <div className="flex items-center gap-2">
          ...
          <button className="px-2 py-[2px] border border-[#E9E9EA] rounded-[5px] cursor-pointer">
            <img src={fullScreen} alt="Full Screen Icon" />
          </button>
        </div>
      </div>
      <div className=" w-full max-w-ful overflow-hiddden">
        <TimelineBar />
      </div>
        ...
        >
          ...
          <div className={`flex w-full items-end gap-3`}>
            <div className="flex flex-col items-center gap-1">
              <img src={videoIcon} height={32} className="max-w-[33px]" alt="Video Icon" />
                  ...
                  left:
                    timelineItems.length > 0
                      ? `${
                          ...
                          (timelineItems.reduce(
                            (total, video) => total + video.duration * 10 -2 ,
                            0
                          ) +
                        ...
                        {video.thumbnails.map(
                          (thumbnail, thumbIndex: number) => (
                            <img
                              ...
                              alt="Thumbnail"
                              className="h-full"
                              // 10second * 10 == 100 / 10  = 10 * 10 = 100px width for total
                              style={{
                                width: `${Math.round(
                                  (video.duration * 10 -2) /
                                    video.thumbnails.length
                                ) }px`,
                              }} // Distribute thumbnails evenly
                            />
                          )
                        )}
                      </div>
          ...
          <div className={`flex w-full items-end gap-3`}>
            <div className="flex flex-col items-center gap-1">
              <img src={AudioIcon} height={32} className="max-w-[33px]" alt="Video Icon" />
              {/* <p className="text-[8px] font-normal text-[#5F6165] leading-normal text-center">
                Audio
              </p> */}
            </div>
          ...
          <div className="flex h-full w-full items-end gap-3 ">
            <div className="flex flex-col items-center gap-1">
              <img src={AiIcon} height={32} className="max-w-[33px]" alt="Video Icon" />
              {/* <p className="text-[8px] font-normal text-[#5F6165] leading-normal text-center">
                AI
              </p> */}
            </div>
          ...
          <div className="flex w-full items-end gap-3">
            <div className="flex flex-col items-center gap-1">
              <img src={MusicIcon} alt="Video Icon" />
              {/* <p className="text-[8px] font-normal text-[#5F6165] leading-normal text-center">
                Music
              </p> */}
            </div>
