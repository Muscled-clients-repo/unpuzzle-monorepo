...
import PuzzleReflect from "../moderator-view/PuzzleReflect";
import PuzzleCheck from "./agents/PuzzleCheck";
import PuzzleHint from "../moderator-view/PuzzleHint";
import PuzzlePath from "./agents/PuzzlePath";
import { useVideoTime } from "@/app/hooks/useVideoTime";
  ...
  const agentOptions = useMemo(() => [
    {
      ...
      headerTitle: "Puzzle Hint",
      description: "Having trouble? Maybe a hint could help!",
      component:  () => <PuzzleHint videoId={video.id} currentTimeSec={currentTimeSec} />,
    },
    {
      key: "puzzleCheck",
      label: "Puzzle Check",
    ...
    {
      key: "puzzleReflect",
      label: "Puzzle Reflect",
      icon: "/assets/robot.svg",
      iconInactive: "/assets/blind-robot.svg",
      headerTitle: "Puzzle Reflect",
      description: "Reflect on what you've learned so far.",
      component: () => < PuzzleReflect videoId={video.id} currentTimeSec={currentTimeSec} />,
    },
    {
      key: "puzzlePath",
      label: "Puzzle Path",
      icon: "/assets/robot.svg",
      iconInactive: "/assets/blind-robot.svg",
      headerTitle: "Puzzle Path",
      description: "Get a custom learning path and video recommendations.",
      component: () => < PuzzlePath video={video} currentTimeSec={currentTimeSec} />,
    },
