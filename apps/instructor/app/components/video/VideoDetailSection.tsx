...
import AgentLogs from "@/components/analytics/AgentLogs";
        ...
        <div className=" w-[60%] ">
          ...
          <div className="flex items-center mb-4">
            <div className=" relative mr-4">
              <img
                src={video?.instructor?.avatar || "https://randomuser.me/api/portraits/women/44.jpg"}
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">
                {video?.instructor?.bio || "Instructor"}
              </div>
            </div>
          </div>
          {/* About Instructor */}
          <div className="mb-6">
            ...
            <div className="text-gray-700 text-sm">
              {video?.instructor?.bio || "Learn from an experienced instructor."}
            </div>
          </div>
        </div>
        <div className=" w-[40%] ">
