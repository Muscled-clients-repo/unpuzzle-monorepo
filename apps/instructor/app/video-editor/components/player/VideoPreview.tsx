...
const VideoPlayer = forwardRef<VideoPlayerRef, VideoPlayerProps>(({
  ...
  useEffect(() => {
    if (videoRef.current && Math.abs(videoRef.current.currentTime - currentTimeSec.current) > 0.1) {
      videoRef.current.currentTime = currentTimeSec.current;
      setCurrentTime(currentTimeSec.current);
    }
  }, [currentTimeSec]);
